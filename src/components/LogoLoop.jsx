...
export const LogoLoop = memo(({
  ...
  <div
    className={cx(
      ...
      'hover:scale-110 hover:bg-zinc-700 hover:border-zinc-500 my-3'
    )}
  >
    {/* LOGO */}
    <img
      src={item.src}
      alt={item.title}
      className="h-[var(--logoloop-logoHeight)] w-auto object-contain mb-3"
      draggable={false}
    />
    {/* NAMA */}
    ...
    {/* keterangan */}
    <span className="text-sm font-semibold text-white/50 leading-tight">
      {item.desk}
    </span>
